...
#     # Specify user and assistant messages separately
#     messages = [
#         {"role": "assistant", "content": "Your introduction or any context you want to provide."},
...
#     # Extract only the response from the assistant
#     reply = chat.choices[0].message.content
#     print(reply)
